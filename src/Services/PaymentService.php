...
$requestData['order_status'] = (isset($requestData['forced_onhold']) && !empty($requestData['forced_onhold'])) ? trim($this->config->get('Novalnet.novalnet_forced_onhold_order_status')) : trim($this->config->get('Novalnet.novalnet_onhold_confirmation_status'));
                    $requestData['paid_amount'] = 0;
                }
            else {
                    $requestData['order_status'] = trim($this->config->get('Novalnet.'. $requestData['payment_method'] .'_order_completion_status'));
